    ...
    <el-container>
      <el-header height="240">
       ...
       <el-container style="margin-top: 10px;">
        <el-input placeholder="必含关键词（以空格区分）"  size="small"  clearable></el-input>
        <el-input placeholder="可含关键词（以空格区分）"  size="small" clearable></el-input>
        <el-input placeholder="不含关键词（以空格区分）"  size="small"  clearable></el-input>
      </el-container>
      <el-container style="margin-top: 10px;">
        <el-select multiple collapse-tags size="small"  placeholder="请输入公司代码、简称" filterable>
          <el-option ></el-option>
        </el-select>
        <el-select  multiple collapse-tags size="small" placeholder="处罚对象身份" filterable>
          <el-option ></el-option>
        </el-select>
        <el-select multiple collapse-tags size="small" placeholder="申辩情况" filterable>
          <el-option></el-option>
        </el-select>
      </el-container>
      <el-container style="margin-top: 10px;">
        <el-date-picker  type="date"  placeholder="起始日期"></el-date-picker>
        <el-date-picker  type="date"  placeholder="结束日期"></el-date-picker>
        <el-select multiple collapse-tags size="small" placeholder="所属板块" filterable>
          <el-option></el-option>
        </el-select>
      </el-container>
      <el-container style="margin-top: 10px;">
        <el-select multiple collapse-tags size="small"  placeholder="所属行业" filterable>
          <el-option ></el-option>
        </el-select>
        <el-select  multiple collapse-tags size="small" placeholder="所属地区" filterable>
          <el-option ></el-option>
        </el-select>
        <el-select multiple collapse-tags size="small" placeholder="监管机构" filterable>
          <el-option></el-option>
        </el-select>
      </el-container>
       <el-container style="margin-top: 10px;">
         <el-button type="primary" icon="el-icon-search" size="small" style="margin-top: 20px;">查询</el-button>
         <el-button type="warning"  size="small" style="margin-top: 20px;" >清空查询</el-button>
      </el-container>
      <!-- 搜索条件结束 -->
      </el-header>
      <el-main :height="dataHeight">
       ...
       <!--分页开始-->
       <el-footer height="45">
         <div style="padding: 10px 15px 0px; height: 32px; line-height: 32px; text-align: center;width:100%;margin:0px;">
